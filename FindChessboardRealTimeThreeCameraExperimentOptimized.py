    ...
    if ret or ret2 or ret3:
        ...
        if len(imgpoints3) > 5:  # Third camera
            ...
            if retr3 < RMS_thresh:
                ...
                draw_str(img3, (20, 200), 'max_range_with_3_cameras: ' + str(max_range1_2 - max_x_camera1 + max_x_camera3))
                draw_str(img3, (20, 220), 'max_range_with_3_cameras: ' + str(-min_x_camera2 + max_x_camera3))
                cv2.imshow('img', img)
                cv2.imshow('img2', img2)
                cv2.imshow('img3', img3)
                cv2.waitKey(1)
        ...
        cv2.imshow('img3', img3)
        cv2.waitKey(1)
        print("No Chessboard Found", experiment_1, experiment_2, experiment_3)
        # For the future
        # experiment_1 = False, experiment_2 = False, experiment_3 = False
